...
<body>
    ...
    <?php
        if(isset($_SESSION['username']))
        {
            $query = "SELECT Empleado.id_empleado, Empleado.nombre_empleado, Empleado.apellidos_empleados, Departamento.nombre_departamento FROM Empleado JOIN Departamento ON Empleado.id_departamento = Departamento.id_departamento";
